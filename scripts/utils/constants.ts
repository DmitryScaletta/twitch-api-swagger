...
export const RESPONSE_BODY_SCHEMA_NAMES: Record<string, [path: string, name: string][]> = {
  ...
  'create-custom-rewards':                  [['data[0]', 'CustomReward'], /*['data[0].image', 'CustomRewardImage'], ['data[0].default_image', 'CustomRewardImage'] */],
  'get-custom-reward':                      [['data[0]', 'CustomReward'], /*['data[0].image', 'CustomRewardImage'], ['data[0].default_image', 'CustomRewardImage'] */],
  'update-custom-reward':                   [['data[0]', 'CustomReward'], /*['data[0].image', 'CustomRewardImage'], ['data[0].default_image', 'CustomRewardImage'] */],
  ...
  'get-content-classification-labels':      [['data[0]', 'ContentClassificationLabel']],
  ...
  'get-guest-star-session':                 [['data[0]', 'GuestStarSession'], ['data[0].guests', 'Guest']],
  'create-guest-star-session':              [['data[0]', 'GuestStarSession'], ['data[0].guests', 'Guest']],
  'end-guest-star-session':                 [['data[0]', 'GuestStarSession'], ['data[0].guests', 'Guest']],
  'get-guest-star-invites':                 [['data[0]', 'GuestStarInvite']],
  ...
  // 'get-polls':                              [['data[0]', 'Poll'], ['data[0].choices', 'PollChoice']],
  // 'create-poll':                            [['data[0]', 'Poll'], ['data[0].choices', 'PollChoice']],
  // 'end-poll':                               [['data[0]', 'Poll'], ['data[0].choices', 'PollChoice']],
