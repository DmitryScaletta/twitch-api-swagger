...
export const responseBodySchemaNames: Record<string, [path: string, name: string][]> = {
  ...
  'get-soundtrack-current-track':           [['data[0]', 'SoundtrackCurrentTrackInfo']],
  'get-soundtrack-playlist':                [['data[0]', 'SoundtrackPlaylist']],
  'get-soundtrack-playlists':               [['data[0]', 'SoundtrackPlaylists']],
