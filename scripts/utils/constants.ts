...
export const RESPONSE_BODY_SCHEMA_NAMES: Record<string, [path: string, name: string][]> = {
  ...
  'get-guest-star-session':                 [['data[0]', 'GuestStarSession'], /* ['data[0].audio_settings', 'MediaSettings'], ['data[0].video_settings', 'MediaSettings'] */],
  'create-guest-star-session':              [['data[0]', 'GuestStarSession'], /* ['data[0].audio_settings', 'MediaSettings'], ['data[0].video_settings', 'MediaSettings'] */],
  'end-guest-star-session':                 [['data[0]', 'GuestStarSession'], /* ['data[0].audio_settings', 'MediaSettings'], ['data[0].video_settings', 'MediaSettings'] */],
